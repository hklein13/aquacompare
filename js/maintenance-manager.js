...
window.maintenanceManager = {
                    ...
                    <form class="event-form" id="event-log-form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="event-type-grid" id="event-type-grid">
                                ${Object.entries(this.eventTypes).map(([key, info]) => `
                    ...
                    <div class="form-group">
                        ...
                        <select id="fish-species">
                            ...
                            ${Object.entries(window.fishDatabase || {})
                                .sort((a, b) => (a[1].commonName || '').localeCompare(b[1].commonName || ''))
                                .map(([key, fish]) => `<option value="${key}">${fish.commonName}</option>`)
                                .join('')}
                        </select>
                    </div>
                    <div class="form-group">
    ...
    openScheduleModal(tankId, tankName, existingSchedule = null) {
        ...
        const intervalDays = existingSchedule?.intervalDays || this.scheduleTypes[scheduleType]?.defaultDays || 7;
                    ...
                    <form class="event-form" id="schedule-form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="schedule-type-grid" id="schedule-type-grid">
                                ${Object.entries(this.scheduleTypes).map(([key, info]) => `
    ...
    renderSchedulePills(container, schedules, tankId, tankName) {
        ...
        container.innerHTML = sortedSchedules.map(schedule => {
            ...
            const label = schedule.type === 'custom' && schedule.customLabel
